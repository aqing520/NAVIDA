...
TRAIN_FILE="${TRAIN_FILE:-$REPO_ROOT/data/train_r2r_rxr_qwen3vl4b_full_with_dagger.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_ROOT/result/qwen3vl4b_r2r_rxr_dagger_zero2}"
